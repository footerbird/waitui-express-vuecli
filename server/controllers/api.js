...
module.exports = {
    //资讯列表（ajax加载）
    get_articleListBaseAjax: function (req, res, next) {
    ...
    //资讯列表加载更多（ajax加載）
    get_articleListAjax: function (req, res, next) {
        pool.getConnection(async function(err, connection) {
            var article_model = require('../models/article_model.js');
    ...
    //资讯搜索（ajax加载）
    get_articleSearchBaseAjax: function (req, res, next) {
        pool.getConnection(async function(err, connection) {
            var article_model = require('../models/article_model.js');
            var flash_model = require('../models/flash_model.js');
    ...
    //资讯搜索加载更多（ajax加載）
    get_articleSearchAjax: function (req, res, next) {
        pool.getConnection(async function(err, connection) {
            var article_model = require('../models/article_model.js');
            //req.params取的是url段的参数，req.query取的是?后的参数，req.body取的是ajax或者说是取你post方法中form里的传来的key value
            var keyword = req.body.keyword?req.body.keyword:'';
    ...
    //资讯详情（ajax加载）
    get_articleDetailBaseAjax: function (req, res, next) {
        pool.getConnection(async function(err, connection) {
            var article_model = require('../models/article_model.js');
            var flash_model = require('../models/flash_model.js');
            var article_id = req.body.article_id?req.body.article_id:1;
